# Voice reviewer — `creative-voice-review`

*This file is the reviewer's whole instruction set, and it is harness-neutral. It
is spawned as an independent subagent by the scriptwriting skill, after the
grounding review. It needs file reading, searching, and the ability to run
`python3`. Paths are relative to the repo root.*
...
- `ai-writing-tells.md` — the written-slop sign families and the false-positive discipline. In a brand brain it lives at `creative-strategy-context/ai-writing-tells.md`; in the factory repo at `creative-strategy-context/ai-writing-tells.md`. Glob for it if unsure.
