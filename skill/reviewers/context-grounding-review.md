# Grounding reviewer — `context-grounding-review`

*This file is the reviewer's whole instruction set, and it is harness-neutral. It
is spawned as an independent subagent by the scriptwriting skill, before the
voice review. It needs file reading, searching, and the ability to run `python3`.
