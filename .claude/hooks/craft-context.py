...
INSTRUCTION = (
    "The base harness knows nothing about creative strategy, so assume your own "
    ...
    "(.claude/skills/ or .codex/skills/, whichever this harness uses) and ship with both "
    "gate receipts (Grounding Review, Voice Review). "
