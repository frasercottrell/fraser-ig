...
**Reusable B-rolls (pick any):** setting up a light · adjusting the camera · typing at the laptop ·
scrubbing an ad timeline on screen · coffee + notes. Always some movement.

**Freebie keywords (ManyChat):** SWIPE = ad swipe file · HOOKS = hooks doc · CONVERT = "why your ads don't convert" PDF
...
**Caption:**
Everyone saw the Nike ad go viral and rushed to copy the format.
...
Follow for ad breakdowns that actually explain the mechanism 👊
Comment SWIPE and I'll send you 20 ads worth studying (with notes on why they work).
...
You're optimising the wrong half.

Follow for more on what actually moves performance.
Comment CONVERT for the 5 reasons ads stop converting (and the fixes).
...
We rebuilt our own version with AI. Faster, tailored to how we actually work, no subscription.

This is the part nobody tells you about AI in advertising: the win isn't "make ads faster." It's rebuilding the expensive bits of your stack so they fit your process instead of someone else's.

Most people are using AI to do the old thing quicker. The edge is using it to do a different thing entirely.

Follow for how a real agency is actually using AI (not the hype version).
Comment SWIPE for our ad breakdown vault.
...
**Caption:**
The ad you scroll past took more decisions than you'd think.

Concept → hook angles → script → shot list → edit → variations → QA. Every step is a place it can quietly die.

Most brands skip straight to "let's film something" and wonder why it flops. The work that makes an ad perform happens before the camera turns on.

Follow to see how the sausage actually gets made.
Comment HOOKS for the hook doc we start every concept with.
...
Rewrite the opening before you touch anything else.
...
You should know what's working and why. Every week. No exceptions.

Follow if you want to actually understand your own ad account.
Comment CONVERT for the audit questions we'd ask your account first.
...
Comment HOOKS for 30 hooks you can hand your team instead.
