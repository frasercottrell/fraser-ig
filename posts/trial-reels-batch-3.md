...
Follow for what actually moves ad performance.
...
**Caption:**
Ten thousand ads in and the pattern doesn't change. The first three seconds decide almost everything. Everything after is fighting over the scraps of attention the hook won or lost.

I used to spread the effort evenly across the whole ad. Now most of the thinking goes into the opening, because that's where the money is actually made or lost.

Spend your time where the result is decided.

Follow for more from 10,000+ ads made.
Comment HOOKS for 30 hooks you can start from.
...
People think scaling is a spend problem. Most of the time it's a first-three-seconds problem.

Follow for more creative fixes that move the number.
Comment CONVERT for the audit questions we'd ask your account.
...
Follow for the mistakes I see brands make on repeat.
Comment CONVERT for the 5 most common ones (with fixes).
...
**Caption:**
A winning ad with no explanation isn't a win. It's a coin flip you can't repeat.

The whole point of a creative partner is that they can look at the winner and tell you the mechanism. This hook. This angle. This is why it landed. Then they build the next one on the same insight. If every good result is a surprise and every bad one is "the algorithm," you're funding guesswork.

You should be able to see why. Every week.

Follow if you want to actually understand your own account.
Comment CONVERT for the questions to ask your agency this week.
...
Fix the hook before you touch the funnel. That's where the money's leaking.

Follow for more on where ad money actually goes to die.
Comment CONVERT for the 5 reasons ads don't convert.
