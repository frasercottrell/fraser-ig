...
grounding reviewer (skill/reviewers/context-grounding-review.md), which runs
this first and then decides what the findings mean.
...
PATH_PREFIXES = [
    ...
    # The harness-neutral skill layout: a doc may be cited by its short name.
    "skill/",
    "skill/scriptwriting/",
    "skill/reviewers/",
]
